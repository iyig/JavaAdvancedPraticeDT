  ...
  /*
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        unvanEkle("Dr.", isim);
kisaltmaekle(isim);
ilkHarfBuyukSoyIsimTamamBuyuk(isim);
    }
...
public static void kisaltmaekle(String deger){
    deger=  deger.replace("eli",".");
    System.out.println(deger);
}
  public static void ilkHarfBuyukSoyIsimTamamBuyuk(String deger){

deger=deger.replace("Can","CAN");
      System.out.println(deger);
